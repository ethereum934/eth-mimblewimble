...
## Pre-requisite
Install docker and GNU Make & Python3 & Python virtualenv
...
## Make commands
 ...
 1. zk-SNARKs Circuits
     ...
     │   ├── mmr
     │   │   ├── ...
     │   │   ├── zkMMRInclusion.code # Verfies inclusion of an item in the given MMR root.
     │   │   ├── zkRollUp1.code # Updates MMR root appending 1 item.
     │   │   ├── zkRollUp2.code # Updates MMR root appending 2 items.
     │   │   ├── zkRollUp4.code # Updates MMR root appending 4 items.
     │   │   ├── zkRollUp8.code # Updates MMR root appending 8 items.
     │   │   ├── zkRollUp16.code # Updates MMR root appending 16 items.
     │   │   ├── zkRollUp32.code # Updates MMR root appending 32 items.
     │   │   └── zkRollUp64.code # Updates MMR root appending 64 items.
     │   ├── ...
     │   ├── zkDeposit.code # Verifies depositing spent tag(nullifier) satisfies the given condition.
     │   ├── zkMimblewimble.code # Verifies the transaction satisfies the Mimblewimble protocol.
     │   ├── zkRangeProof.code # Verifies the given TXO's value is between the given range.
     │   └── zkWithdraw.code # Verifies the withdrawing TXO exists in the given root.
     ├── containers: Dockerfiles to make proof generator containers using the above circuits.
     ├── tests
     │   ├── circuits
     │   │   ├── ...
     │   │   └── unitTest.code # Tests Mimblewimble circuits and MMR circuits
     ├── utils
...
- ethereum934/zk-deposit
    - public: [tag, v]
    - private: [r]
    - circuit: circuits/zkDeposit.code
- ethereum934/zk-range-proof
    - public: [y]
    - private: [r, v]
    - circuit: circuits/zkRangeProof.code
